...
const RazorpayPage = () => {
  ...
  const type = JSON.parse(localStorage.getItem("paymentType"))?.paymentType;
  const {
  ...
  return (
    <Box p={20} bgGradient="linear(to-b, #F3ECFF, #FFFFFF)" borderRadius="xl">
      <VStack spacing={4}>
        <Box
          bg="white"
          borderRadius="full"
        ...
        >
          <Box
            position="absolute"
            left={billingCycle === "monthly" ? "4px" : "calc(100% - 50%)"}
            w={["47%", "48%", "298px"]}
            h={["38px", "45px", "52px"]}
            borderRadius="full"
          ...
          {role === "CORPORATE_ADMIN" ? (
            <>
              {type && type == "pro" ? (
                ...
                <PricingCard
                  ...
                  onBuy={() =>
                    handlePayment(billingCycle === "monthly" ? 0 : 0, "free")
                  }
                  isCustomfree
                />
              )}
              <PricingCard
                ...
                onBuy={() =>
                  handlePayment(billingCycle === "monthly" ? 2500 : 2250, "Pro")
                }
              />
              <PricingCard
                title="Enterprise"
            ...
            <>
              ...
              <PricingCard
                ...
                onBuy={() =>
                  handlePayment(billingCycle === "monthly" ? 3800 : 3420, "Pro")
                }
              />
              <PricingCard
                title="Enterprise"
