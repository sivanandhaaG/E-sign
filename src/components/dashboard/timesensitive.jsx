  ...
  return (
    <Container fluid className="mt-5">
      <Row className="mb-md-0 mb-1">
        <Col md={6} sm={12}>
          <p className="dashboard-p-title mb-0"> Time Sensitive </p>
          <p className="personal-email-name"> Time Sensitive Documents </p>
        </Col>
      </Row>
      <Row className="px-2">
      ...
      <Row className="mt-3">
        <Col sm={12} md={12}>
          ...
          <Row className="mt-md-4 mt-0">
            <Col xs={12} md={4} className="px-3">
              <hr />
            </Col>
            <Col xs={12} md={4}>
              <Button size="md" className="px-0 w-100 btn-bg-white text-center">
                <img style={{ width: 14 }} src={PlusIcon2} alt="" /> Add Custom
                Report{" "}
              </Button>
            </Col>
            <Col xs={12} md={4} className="px-3">
