...
import DownloadGrayIcon from '../../assets/images/general/downloadgray.png';
...
const RequiredAction = () => {
  ...
  return (
    <Container fluid className='mt-5'>
      <Row className='pt-md-5 py-2'>
        <Col md={3} sm={12} className='border-side-css'>
          <TabIndex />
        </Col>
        <Col md={9} sm={12}>
          <Row className='mb-md-0 mb-1'>
            <Col md={6} sm={12}>
              <p className='dashboard-p-title mb-0'> Required Action </p>
              <p className='personal-email-name'> Action Required Documents </p>
            </Col>
          </Row>
          <Row className='px-2'>
              ...
              <Row className=''>
                <Col md={12} className='mt-3'>
                  <div className='border border-2' style={{ borderRadius: 5 }}>
                    <Table className='' bordered hover responsive='md'>
                      ...
                      <tbody style={{ height: 370 }}>
                        {currentData.map((item) => (
                          <tr key={item.id} className='dash-table-body'>
                            <td style={{ width: '50%' }}>{item.remark}</td>
                            <td
                              className='text-center'
                              style={{ width: '25%' }}
                            >
                              <img src={DownloadGrayIcon} alt='' />
